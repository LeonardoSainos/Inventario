<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="searchModels-view.ascx.cs" Inherits="Inventario.Inventario.admin.ModeloVehiculos.searchModels_view" %><%@ Import Namespace="Inventario.Scripts" %>
...
<div class="container">
    ...
    <div style="display:flex; float:right;">
        <input id="busqueda" style="width: 80%; float:left;" placeholder="Buscar modelos" value="<%=Buscar %>"  name="busqueda" class="form-control mr-sm-2 alin" type="text" />
    ...
    <div class="row">
      <div class="col-md-12 text-center">
           <ul class="nav nav-pills nav-justified">
             <li><a href="./admin.aspx?view=models"><i class="fa fa-car"></i>&nbsp;&nbsp;Todos los modelos &nbsp;&nbsp;<span class="badge"> <%Response.Write(row1);%></span></a></li>
         </ul>
       </div>
  </div>
    <br />
