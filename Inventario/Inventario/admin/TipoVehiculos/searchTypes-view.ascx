<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="searchTypes-view.ascx.cs" Inherits="Inventario.Inventario.admin.TipoVehiculos.searchTipos_view" %>
...
<div id="contenido">
    ...
    <div class="container">
        ...
        <div style="display:flex; float:right;">
              <input id="busqueda" style="width: 80%; float:left;" placeholder="Buscar tipos de Vehículos"   name="busqueda" class="form-control mr-sm-2 alin" type="text" value="<%=Buscar %>"/>
             <a id="st" href="javascript:void()" style="float:right;" placeholder="Buscar" class="btn btn-warning" type="submit"><span class="glyphicon glyphicon-search"></span></a>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <ul class="nav nav-pills nav-justified">
                    <li><a href="./admin.aspx?view=types"><i class="fa fa-car"></i>&nbsp;&nbsp;Tipos de vehiculos&nbsp;&nbsp; <span class="badge"><%Response.Write(row1); %></span></a></li>
