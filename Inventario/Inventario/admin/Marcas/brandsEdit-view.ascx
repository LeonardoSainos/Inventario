<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="brandsEdit-view.ascx.cs" Inherits="Inventario.Inventario.admin.Marcas.brandsEdit_view" %>
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-3">
         ...
         <div class="col-sm-9">
                <a href="./admin.aspx?view=brands" class="btn btn-warning btn-sm pull-right"><i class="fa fa-reply"></i>&nbsp;&nbsp;Volver a marcas</a>
         </div>
    </div>
</div>
