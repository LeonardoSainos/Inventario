<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="brands-view.ascx.cs" Inherits="Inventario.Inventario.admin.Marcas.brands_view" %>
...
<div class="container">
    ...
    <div style="display:flex; float:right;">
        <input id="busqueda" style="width: 80%; float:left;" placeholder="Buscar marcas"   name="busqueda" class="form-control mr-sm-2 alin" type="text" />
    ...
    <div class="row">
      <div class="col-md-12 text-center">
           <ul class="nav nav-pills nav-justified">
             <li><a><i class="fa fa-car"></i>&nbsp;&nbsp;Todas las marcas &nbsp;&nbsp;<span class="badge"> <%Response.Write(row1);%></span></a></li>
         </ul>
       </div>
  </div>
    <br />
    ...
    <nav arial-label="Page navigation" class="text-center">
        <ul class="pagination">
            ...
            <%}
                ...
                { %>
             <li>
                 <a href="./admin.aspx?view=brands&pagina=<%Response.Write(pagina - 1); %>" aria-label="Previous">
                     <span aria-hidden="true">&laquo;</span>
                 </a>
             </li>
               <%}
                   for (int i = 1; i <= numPagina; i++)
                   {
                       if (pagina == i)
                       {
                           Response.Write("<li class='active'><a href='./admin.aspx?view=brands&pagina=" + i + "'>" + i + " </a></li>");
                       }
                       else
                       {
                           Response.Write("<li><a href='./admin.aspx?view=brands&pagina=" + i + "'>" + i + "</a></li>");
                       }
                   }
                   if (pagina == numPagina)
                   {%>
                  ...
                  {%>
                 <li>
                        <a href="./admin.aspx?view=bramds&pagina=<%Response.Write(pagina + 1); %>" aria-label="Previous">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                <%} %>
