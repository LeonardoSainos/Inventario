...
namespace Inventario.Inventario.admin.Actions
{
    ...
    { MySql AddCarsMysql = new MySql();
        ...
        {
            if (Request.Form["Geconomico"] != null || Request.Form["Gtype"] != null)
            {
                ...
                int type = Convert.ToInt32(Functions.RequestPost(Request.Form["Gtype"]));
                ...
                int Useroperador = Convert.ToInt32(Functions.RequestPost(Request.Form["Goperador"]));
                consulta = $"SELECT * FROM VEHICULO WHERE (nombre_vehiculo='{Necnonomico}' OR placas='{placas}') OR (poliza_seguro='{poliza}' OR Numero_Serie='{Nserie}')";
            ...
            query = "SELECT id_modelo,nombre FROM MODELO";
            ...
            query = "SELECT * FROM mysql_ticket ...  ESTATUS";
            ...
            query = "SELECT id_cliente, nombre_completo FROM mysql_ticket ...  CLIENTE";
            ...
            query = "SELECT id_propietarioEmpresa,nombre FROM PROPIETARIO_VEHICULO";
            ...
            query = "SELECT id_gps,nombre FROM GPS";
