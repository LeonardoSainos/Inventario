<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeleteBrand.ascx.cs" Inherits="Inventario.Inventario.admin.Actions.DeleteBrand" %>
       ...
       <div style="align-items:center; justify-content:center;" class="modal-footer">
                    <center> 
                             <form  id="formulario" style="display: inline-block;" method="post" >                  
                                  <input  type="hidden" name="id_deleB"   id="borrar_idB" />       
