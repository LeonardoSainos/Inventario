...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                         ...
                         <!-- admins -->
                    <% if(Session["rol"].ToString() == "4046" && (Request.Browser.ScreenPixelsWidth <= 768 && Request.Browser.ScreenPixelsHeight <= 992)) { %>
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle configuracion-link" data-toggle="dropdown">
            <span class="glyphicon glyphicon-user"></span>Configuración<b class="caret"></b>
        </a>
        <ul class="dropdown-menu">
            <li>
